...
Partial Class Facilitator_Summatives
    ...
    Private Sub InitializeComponent()
        Dim resources As ComponentModel.ComponentResourceManager = New ComponentModel.ComponentResourceManager(GetType(Facilitator_Summatives))
        Button6 = New Button()
        Button5 = New Button()
        Button3 = New Button()
        Button2 = New Button()
        ...
        Button6.Location = New Point(2, 159)
        ...
        Button5.Location = New Point(2, 132)
        ...
        PanelLeft.Location = New Point(946, 0)
        ...
        Logout.Location = New Point(2, 188)
        ...
        Name = "Facilitator_Summatives"
        Text = "Facilitator_Summatives"
