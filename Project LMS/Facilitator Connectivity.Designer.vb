...
Partial Class Facilitator_Connectivity
    ...
    Private Sub InitializeComponent()
        Dim resources As ComponentModel.ComponentResourceManager = New ComponentModel.ComponentResourceManager(GetType(Facilitator_Connectivity))
        Button2 = New Button()
        panelTop = New Panel()
        Label3 = New Label()
        Label2 = New Label()
        ...
        Logout.Location = New Point(2, 106)
        ...
        Name = "Facilitator_Connectivity"
        Text = "Facilitator_Connectivity"
