...
Partial Class Facilitator_Practicals
    ...
    Private Sub InitializeComponent()
        Dim resources As ComponentModel.ComponentResourceManager = New ComponentModel.ComponentResourceManager(GetType(Facilitator_Practicals))
        Button6 = New Button()
        Button4 = New Button()
        Button3 = New Button()
        Button2 = New Button()
        ...
        Button6.Location = New Point(0, 157)
        ...
        Name = "Facilitator_Practicals"
        Text = "Facilitator_Practicals"
