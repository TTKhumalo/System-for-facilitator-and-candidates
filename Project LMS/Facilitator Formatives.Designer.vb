...
Partial Class Facilitator_Formatives
    ...
    Private Sub InitializeComponent()
        Dim resources As ComponentModel.ComponentResourceManager = New ComponentModel.ComponentResourceManager(GetType(Facilitator_Formatives))
        Button6 = New Button()
        Button5 = New Button()
        Button4 = New Button()
        Button2 = New Button()
        ...
        Button5.Location = New Point(2, 131)
        ...
        Button4.Location = New Point(2, 106)
        ...
        Logout.Location = New Point(2, 187)
        ...
        Name = "Facilitator_Formatives"
        Text = "Facilitator_Formatives"
