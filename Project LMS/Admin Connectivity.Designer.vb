...
Partial Class Admin_Connectivity
    ...
    Private Sub InitializeComponent()
        Dim resources As ComponentModel.ComponentResourceManager = New ComponentModel.ComponentResourceManager(GetType(Admin_Connectivity))
        PanelLeft = New Panel()
        Logout = New Button()
        Button5 = New Button()
        Button4 = New Button()
        ...
        PanelLeft.Location = New Point(940, 72)
        ...
        Logout.Location = New Point(0, 108)
        ...
        Button5.Location = New Point(0, 81)
        ...
        panelTop.Size = New Size(1058, 72)
        panelTop.TabIndex = 6
        ' 
        ' Label3
        ' 
        ...
        PictureBox3.Location = New Point(0, 195)
        ...
        PictureBox4.Location = New Point(882, 77)
        ...
        PictureBox2.Location = New Point(823, 84)
        ...
        PictureBox5.Location = New Point(764, 84)
        ...
        Name = "Admin_Connectivity"
        Text = "Admin_Connectivity"
