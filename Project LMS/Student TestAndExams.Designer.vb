...
Partial Class Student_TestAndExams
    ...
    Private Sub InitializeComponent()
        ...
        Dim resources As ComponentModel.ComponentResourceManager = New ComponentModel.ComponentResourceManager(GetType(Student_TestAndExams))
        Button2 = New Button()
        Logout = New Button()
        Button6 = New Button()
        Button3 = New Button()
        ...
        Logout.Location = New Point(3, 301)
        Logout.Name = "Logout"
        ...
        Button6.Location = New Point(3, 253)
        ...
        panelTop.Size = New Size(1351, 120)
        ...
        PanelLeft.Location = New Point(1351, 0)
        ...
        Button5.Location = New Point(6, 126)
        ...
        Name = "Student_TestAndExams"
        Text = "Student_TestAndExams"
