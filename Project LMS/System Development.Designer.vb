...
Partial Class System_Development
    ...
    Private Sub InitializeComponent()
        Dim resources As ComponentModel.ComponentResourceManager = New ComponentModel.ComponentResourceManager(GetType(System_Development))
        Button5 = New Button()
        Button4 = New Button()
        Button3 = New Button()
        panelTop = New Panel()
        ...
        Button5.Location = New Point(2, 129)
        ...
        Button4.Location = New Point(2, 104)
        ...
        Button3.Location = New Point(2, 78)
        ...
        PanelLeft.Location = New Point(944, 0)
        ...
        Logout.Location = New Point(2, 156)
