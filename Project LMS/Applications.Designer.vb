...
Partial Class Applications
    ...
    Private Sub InitializeComponent()
        Dim resources As ComponentModel.ComponentResourceManager = New ComponentModel.ComponentResourceManager(GetType(Applications))
        PanelLeft = New Panel()
        Logout = New Button()
        Button6 = New Button()
        Button5 = New Button()
        ...
        PanelLeft.Location = New Point(939, 72)
        ...
        Logout.Location = New Point(1, 107)
        ...
        Button6.Location = New Point(1, 82)
        ...
        Button5.Location = New Point(1, 55)
        ...
        panelTop.Size = New Size(1057, 72)
        panelTop.TabIndex = 6
        ' 
        ' Label3
        ' 
