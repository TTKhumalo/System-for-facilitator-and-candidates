...
Partial Class Admin_Finances
    ...
    Private Sub InitializeComponent()
        Dim resources As ComponentModel.ComponentResourceManager = New ComponentModel.ComponentResourceManager(GetType(Admin_Finances))
        PanelLeft = New Panel()
        Logout = New Button()
        Button6 = New Button()
        Button4 = New Button()
        ...
        PanelLeft.Location = New Point(941, 72)
        PanelLeft.Margin = New Padding(2)
        PanelLeft.Name = "PanelLeft"
        PanelLeft.Size = New Size(118, 378)
        ...
        Logout.Location = New Point(2, 108)
        ...
        Button6.Location = New Point(2, 83)
        ...
        Button4.Location = New Point(2, 58)
        ...
        Button3.Location = New Point(2, 32)
        ...
        panelTop.Size = New Size(1059, 72)
        panelTop.TabIndex = 6
        ' 
        ' Label3
        ' 
        ...
        PictureBox3.Location = New Point(0, 197)
        ...
        PictureBox4.Location = New Point(882, 79)
        ...
        PictureBox2.Location = New Point(823, 86)
        ...
        PictureBox5.Location = New Point(764, 86)
