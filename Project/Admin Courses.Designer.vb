...
Partial Class Admin_Courses
    ...
    Private Sub InitializeComponent()
        Dim resources As ComponentModel.ComponentResourceManager = New ComponentModel.ComponentResourceManager(GetType(Admin_Courses))
        PanelLeft = New Panel()
        Logout = New Button()
        Button6 = New Button()
        Button5 = New Button()
        ...
        Button5.Location = New Point(2, 56)
        ...
        Button3.Location = New Point(2, 30)
        ...
        PictureBox3.Location = New Point(0, 190)
        ...
        PictureBox4.Location = New Point(882, 75)
        ...
        PictureBox2.Location = New Point(823, 82)
        ...
        PictureBox5.Location = New Point(764, 82)
